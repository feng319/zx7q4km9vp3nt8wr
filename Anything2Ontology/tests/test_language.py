...
def test_relational_prompt_has_both_languages():
    """RELATIONAL_INCREMENTAL_PROMPT dict has both 'en' and 'zh' keys."""
...
def test_meta_prompts_have_both_languages():
    ...
    for prompt_dict in [
        MAPPING_DIFF_PROMPT, MAPPING_SYSTEM_PROMPT,
        EUREKA_DIRECT_PROMPT, EUREKA_SYSTEM_PROMPT,
...
def test_chatbot_templates_have_both_languages():
    """Chatbot system prompt, finalize prompt, and anchor prompt have both languages."""
