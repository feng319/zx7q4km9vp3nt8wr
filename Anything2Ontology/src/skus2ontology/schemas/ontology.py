...
class OntologyManifest(BaseModel):
    ...
    has_chunk_mapping: bool = False
    chunk_coverage_ok: bool = False
    has_spec: bool = False
...
class AnchorPhase(BaseModel):
    """Phase 2: anchor reference replacement metadata."""

    system_prompt: str = ""
    user_prompt: str = ""
    response: str = ""
    total_anchors_before: int = 0
    remaining_anchors: int = 0
    all_replaced: bool = False
...
class ChatSession(BaseModel):
    ...
    anchor_phase: Optional[AnchorPhase] = None
